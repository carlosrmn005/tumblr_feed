...
1. Is there a way to send the image to the photoDetailView without URL?
2. Is there a way to set height without tableview.rowHeight?

## Video Walkthrough

Here's a walkthrough of implemented user stories:

<img src='https://imgur.com/wEWQhns.gif' title='tumblr_feed demo2' width='372' alt='tumblr_feed demo2' />
